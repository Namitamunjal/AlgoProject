    ...
    <div>
      ...
      <body>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-8 rounded-lg shadow-2xl w-11/12 sm:w-2/3 lg:w-1/3 relative">
              ...
              <p className="text-gray-700">
                {activeModal === "Overview" && "This is the overview section providing a general summary."}
                {activeModal === "Energy Usage" && "Details about energy usage and metrics are displayed here."}
                {activeModal === "Carbon Offset" && "Information about carbon offset initiatives and goals."}
                {activeModal === "Alerts" && "View alerts and notifications regarding energy and usage updates."}
              </p>
            </div>
          </div>
        )}
        ...
        <main className="lg:ml-64 w-full max-w-full px-4 sm:px-6 md:px-10 space-y-10 mt-16">
          ...
          <footer className="bg-[#D5E7FF] text-gray-700 p-4 lg:p-5 -ml-20 -mr-10">
            <div className="container flex flex-col lg:flex-row justify-between items-center">
              <ul className="space-y-2 lg:space-y-0 text-left mx-auto lg:mx-0 lg:pl-60">
                <li><a href="./about" className="hover:underline">About</a></li>
                <li><a href="#" className="hover:underline">Contact Us</a></li>
                <li><a href="#" className="hover:underline">Privacy Policy</a></li>
                <li><a href="#" className="hover:underline">Terms Conditions</a></li>
              </ul>
              <p className="text-center text-gray-500 text-sm mt-4 lg:mt-0">© 2024 Your Company. All rights reserved.</p>
            </div>
          </footer>
        </main>
        </div>
